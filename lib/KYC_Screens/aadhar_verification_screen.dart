...
import 'package:pcmc_jeevan_praman/KYC_Screens/capture_photo_screen.dart';
...
class AadharVerificationKYCScreen extends StatefulWidget {
  ...
  @override
  State<AadharVerificationKYCScreen> createState() =>
...
class _AadharVerificationKYCScreenState
  ...
  void submitOtp() async {
    ...
    setState(() {
      ...
      // Only hide the submit button, keep OTP field visible
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Visibility(
              visible: !isOtpFieldVisible && !isNextButtonVisible,
              child: Center(
            ...
            if (isOtpFieldVisible) ...[
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 22, // You can increase this as needed
                        color: Colors.black,
                      ),
                      textAlign: TextAlign.center,
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return 'OTP आवश्यक आहे';
                        } else if (value.length != 6) {
                          return 'OTP 6 अंकी असावा';
                        }
                        return null;
                      },
                    ),
              ...
              Visibility(
                visible: isSubmitOtpButtonVisible,
                child: Center(
                  child: ElevatedButton(
