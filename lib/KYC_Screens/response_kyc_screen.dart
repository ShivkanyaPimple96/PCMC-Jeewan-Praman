...
//               messageCode: data['messageCode']?.toString() ?? '',
...
//               dateOfBirth: data['dateOfBirth']?.toString() ?? '',
//               ppoNumber: data['ppoNumber']?.toString() ?? widget.ppoNumber,
//               pensionType: data['pensionType']?.toString() ?? '',
//             ),
//           ),
//           (Route<dynamic> route) => false,
...
// class ResponseKYCScreen extends StatelessWidget {
//   final String message;
//   final bool success;
//     final String ppoNumber;
//       final String mobileNumber;

//   ResponseKYCScreen({required this.message, required this.success, required this.ppoNumber, required this.mobileNumber});
